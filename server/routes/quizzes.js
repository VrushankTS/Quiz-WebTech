...
router.post('/api/quizzes/create-quiz', (req, res) => {
    console.log('Received request to create a new quiz'); // Add this line for logging
...
router.get('/api/quizzes/my-quizzes/:id', checkAuth, (req, res) => {
...
router.get('/api/quizzes/all-quizzes', checkAuth, (req, res) => {
    Quizzes.find()
        .then(result => {
            res.status(200).json(result);
        })
...
router.get('/api/quizzes/get-quiz/:id', checkAuth, (req, res) => {
...
router.post('/api/quizzes/add-comment', checkAuth, (req, res) => {
...
router.post('/api/quizzes/like-quiz', checkAuth, (req, res) => {
